...
class HistoryWritingProvider extends ChangeNotifier {
  ...
  List<HistoryWritingDto> _allHistory = [];

  /// 현재 필터링된 히스토리 목록
  List<HistoryWritingDto> _filteredHistory = [];

  /// 외부 노출용 히스토리 getter
  List<HistoryWritingDto> get history => _filteredHistory;
  ...
  Future<void> loadHistory() async {
    ...
    try {
      ...
      _filteredHistory =
          loaded.map((e) => HistoryWritingDto.fromJson(e)).toList()..sort(
